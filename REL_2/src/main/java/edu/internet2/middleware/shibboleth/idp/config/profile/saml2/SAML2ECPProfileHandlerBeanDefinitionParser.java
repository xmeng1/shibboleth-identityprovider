...
/**
 * Spring bean definition parser for {@link SAML2ECPProfileHandler} profile handler.
 */
public class SAML2ECPProfileHandlerBeanDefinitionParser
        extends AbstractSAML2ProfileHandlerBeanDefinitionParser {

    /** Schema type. */
    public static final QName SCHEMA_TYPE = new QName(ProfileHandlerNamespaceHandler.NAMESPACE, "SAML2ECP");

    /** {@inheritDoc} */
    protected Class getBeanClass(Element arg0) {
        return SAML2ECPProfileHandler.class;
    }
    ...
    protected void doParse(Element config, BeanDefinitionBuilder builder) {
        ...
        if (config.hasAttributeNS(null, "authnContextClassRef")) {
            builder.addPropertyValue("authnContextClassRef", DatatypeHelper.safeTrimOrNullString(config.getAttributeNS(null,
